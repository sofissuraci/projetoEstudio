...
namespace Estudio
{
    public partial class FormConsultar : Form
    {
        ...
        private void btnConsultarMod_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataReader show = modalidade.consultarModalidade(cmbDescricao.Text);

            {
                txtPreco.Text = show["precoModalidade"].ToString();
                txtQtdeAlunos.Text = show["qtdeAlunos"].ToString();
                txtQtdeAulas.Text = show["qtdeAulas"].ToString();
            }
